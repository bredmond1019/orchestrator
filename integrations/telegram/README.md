...
(`<REDACTED-TAILSCALE-IP>`).  No CF Access headers needed — Tailscale handles network-layer auth.
...
instead: `<REDACTED-TAILSCALE-IP>:8080:8080`.  The `X-API-Key` check remains as defense-in-depth
