...
| **Agentic_Engineering_Projects_and_Learning_Plan.md** | Technical: codebase, project library (A–H), Rust CLI track | You need the *how* of a project |
...
## What's *not* here
- **Code repos** live elsewhere. The Python orchestration framework (one monorepo, all Python workflows), the Rust CLI, and the website are separate repos, each with its own `CLAUDE.md` (agent conventions) and `DEVLOG.md` (daily log). See DECISIONS.md for the repo strategy.
