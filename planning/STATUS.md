...
**Last updated:** 2026-06-10 — Mac Mini Tailscale private face: unattended access live (auto-login + connect-on-login, FileVault off), MacBook Pro on the tailnet; Block B (Tailscale) + Block D still run in parallel
