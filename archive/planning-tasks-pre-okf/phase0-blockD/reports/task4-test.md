...
[
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run python -c \"import main\" 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run python -c \"import worker.config\" 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run python -c \"import database.session\" 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run python -c \"import database.repository\" 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run ruff check app/ 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run pylint app/ 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run pytest --collect-only -q 2>&1",
  ...
  },
  {
    ...
    "passed": true,
    "execution_command": "cd ~/agentic-portfolio && uv run pytest 2>&1",
